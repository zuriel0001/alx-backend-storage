...
iA Redis module
    ...
    To Write strings to Redis
    To read from Redis and recover original type
    To Increment values, store lists, Retrieve lists
"""
...
def replay(func: Callable):
    ...
    Return the history of calls of a particular function
    """
    r = redis.Redis()
...
class Cache():
    """
    Store the instance of Redis client as private variable _redis
